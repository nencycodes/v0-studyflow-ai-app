...
const monthlyData = [
  { week: "Week 1", hours: 18, tasks: 12, target: 20 },
  { week: "Week 2", hours: 22, tasks: 15, target: 20 },
  { week: "Week 3", hours: 25, tasks: 18, target: 20 },
  { week: "Week 4", hours: 24.5, tasks: 18, target: 20 },
]

const subjectProgress = [
  { name: "Mathematics", completed: 75, total: 100, hours: 32, color: "var(--chart-1)" },
  { name: "Physics", completed: 60, total: 100, hours: 28, color: "var(--chart-2)" },
  { name: "Chemistry", completed: 45, total: 100, hours: 20, color: "var(--chart-3)" },
  { name: "Biology", completed: 80, total: 100, hours: 18, color: "var(--chart-4)" },
  { name: "English", completed: 90, total: 100, hours: 12, color: "var(--chart-5)" },
]
...
const completedTasks = [
  { id: 1, title: "Calculus Chapter 4 - Derivatives", subject: "Mathematics", completedAt: "Today, 10:30 AM", duration: "2h 15m" },
  { id: 2, title: "Thermodynamics Problems Set", subject: "Physics", completedAt: "Today, 2:45 PM", duration: "1h 30m" },
  { id: 3, title: "Organic Chemistry Notes Review", subject: "Chemistry", completedAt: "Yesterday, 4:00 PM", duration: "45m" },
  { id: 4, title: "Cell Biology Quiz Prep", subject: "Biology", completedAt: "Yesterday, 11:00 AM", duration: "1h" },
  { id: 5, title: "Shakespeare Essay Outline", subject: "English", completedAt: "2 days ago", duration: "1h 45m" },
  { id: 6, title: "Linear Algebra Practice", subject: "Mathematics", completedAt: "2 days ago", duration: "2h" },
]

const pendingTasks = [
  { id: 1, title: "Integration Techniques", subject: "Mathematics", dueDate: "Tomorrow", priority: "high" },
  { id: 2, title: "Waves & Optics Lab Report", subject: "Physics", dueDate: "In 2 days", priority: "medium" },
  { id: 3, title: "Periodic Table Memorization", subject: "Chemistry", dueDate: "In 3 days", priority: "low" },
  { id: 4, title: "Genetics Problem Set", subject: "Biology", dueDate: "In 4 days", priority: "medium" },
]
          ...
          <CardContent>
            <div className="space-y-3 max-h-[400px] overflow-y-auto pr-2">
              {completedTasks.map((task) => (
                ...
                >
                  <CheckCircle2 className="size-5 text-chart-2 mt-0.5 shrink-0" />
